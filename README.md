...
Abstract: _Crowd density and Pedestrian Level of Service (PLOS) are fundamental measures in public safety, event management, and architectural engineering. Visualising specific locations at varying levels of crowd density could aid the organisation of city layouts, event spaces, and buildings, helping prevent crowd crushes and improve overall comfort levels. The visualisation of crowded scenes is a complex process due to their diverse nature; the immense variation found between crowds makes them difficult to generalise. This task calls for a solution capable of understanding the appearance and behaviour of crowds in order to produce believable images of them. The use of Generative Adversarial Networks (GANs) for image synthesis is currently being researched and developed on a large scale, however, there is limited research specific to using these models in PLOS and crowd density manipulation. This project proposes the novel concept of adding accurate crowd density classification in crowd images to the StyleGAN3 architecture, enabling the generation of synthesised crowd images with varying densities. The project also includes structured experimentation of training GANs on crowd image data to evaluate the effectiveness of image generation practices, such as data augmentation and transfer learning. Through the use of qualitative evaluation and quantitative metrics, including Frechet Inception Distance (FID) and loss, StyleGAN3 was found to be well suited to the task of generating manipulably dense crowd images. The simplest method of estimating crowd density using only crowd count was the most accurate according to its FID score of 38.73, followed by the grid method at 40.74. Next up was the Euclidean distance method at 41.3, the grid method with m^2 cell sizes at 41.77, and the normalised crowd count method at 43.81, which suffered from calculation inaccuracies. Similar results can be observed upon qualitative comparison of the generated images. Further value was discovered in the use of transfer learning, with which an FID of 15.01 was reached after 10,000 epochs of unconditional training on the CrowdHuman dataset._
